...
<?php
      ...
      while($row2 = mysqli_fetch_array($query_run))
      {
        ...
        $button = "<td><button type=\"submit\" class=\"btn btn-default assign\" name=\"request\" id=\"request_btn\" >Request</button></td>";
        $dataRow = $dataRow."<tr><form action=\"index.php\" method=\"post\">
...
var request = document.getElementById("request_btn");
